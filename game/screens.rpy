...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot (22, 25, 224, 101) action Start()
        hotspot (22, 171, 224, 101) action ShowMenu("load")
        hotspot (22, 320, 224, 101) action ShowMenu("preferences")
        hotspot (22, 463, 224, 101) action ()
        hotspot (22, 606, 224, 101) action Quit(confirm=True)

        hotspot (1112, 582, 1280, 704) action ShowMenu("preferences")
